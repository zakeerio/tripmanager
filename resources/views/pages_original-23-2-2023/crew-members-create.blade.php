                    ...
                    <div class="form-row">
                                ...
                                <div class="form-group col-xl-8 col-lg-12">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6 hidebox" id="FirstAidbox">
                                            ...
                                            <input type="date" class="form-control" name="faexpire" value="{{ old('faexpire') }}" id="faexpire" >
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-group col-xl-4 col-lg-12">
                            <div class="profile-picture">
                                ...
                                <img src="{{ asset('assets/images/dummy-image.jpeg') }}" style="width: 220px; height: 220px;" class="img-fluid preview"/>
