            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-12">
                    ...
                    <div class="teck-btn justify-content-end">
                        ...
                        <a href="{{ route('developer.activity-items-create') }}"><img src="./assets/images/Activity-Items.png"
                                class="img-fluid">Create new item</a>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="BtnAction">
                                                <a class="dropdown-item"
                                                    href="{{ route('developer.activity-items-edit') }}">Edit</a>
