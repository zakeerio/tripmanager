                        ...
                        <table class="rwd-table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> ADL, CH, KW1, <br> </td>
                                    <td> <span class="active-btn"><img
                                                src="{{ asset('assets/images/Activity-Ready-Button.png') }}"
                                                class="img-fluid" alt=""> Activity Ready</span> </td>
                                ...
                                <tr class="teck-danger">
                                    ...
                                    <td> Drakehouse 2 hour cruis'es </td>
                                    <td> 7.5 hours </td>
                                    <td> 4 Crew Members </td>
                                    <td> ADL, CH, </td>
                                    <td class="crew_btn"> <span class="active-btn-2"><img src="{{ asset('assets/images/Button-Crew-Needed.png') }}" class="alrt-image" alt=""> Crew Needed</span> </td>
                                    ...
                                    <td class="action">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="BtnAction">
                                                <a class="dropdown-item" href="{{ route('crewmember.all-activities-edit', 2) }}">Edit</a>
                                                <a class="dropdown-item" href="#">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td> <span class="active-btn"><img src="{{ asset('assets/images/Activity-Ready-Button.png') }}" class="img-fluid" alt=""> Activity Ready</span> </td>
                                ...
                                <tr>
                                    <td>
                                        <div class="table-div"><img src="{{ asset('assets/images/Picture-02.png') }}"
                                                class="img-fluid" alt="">
                                            <p> <b> Henshall </b> <br> #7083 </p>
                                        </div>
                                    </td>
                                ...
                                <tr class="teck-danger">
                                    ...
                                    <td> 4 Crew Members </td>
                                    <td> ADL, CH, </td>
                                    <td class="crew_btn"> <span class="active-btn-2"><img
                                                src="{{ asset('assets/images/Button-Crew-Needed.png') }}"
                                                class="alrt-image" alt=""> Crew Needed</span> </td>
