...
@section('content')
    ...
    <div class="row dashboard_col" id="crew-members-edit">
        ...
        <div class="col-md-12 dashboard_Sec">
            ...
            <p class="sub-pages-text">Please amend any details below and click save changes to submit the updated information.</p>
                            ...
                            <div class="form-group col-xl-8 col-lg-12">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-xl-4 col-lg-6">
                                        ...
                                        <input type="text" class="form-control" id="PrimaryNumber" name="" value="{{ $crew_member->mobile }}">
                                    </div>
                                    ...
                                    <div class="form-group col-xl-8 col-lg-12">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="Initials" value="{{ $crew_member->initials }}" disabled>
                                            </div>
                                            <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-xl-4 col-lg-12">
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="keyholder" {{ !empty($crew_member->keyholder) ? "checked" : '' }} value="{{ $crew_member->keyholder }}">
                                    ...
                                    <div class="form-group col-xl-8 col-lg-12">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <input type="checkbox" class="form-check-input" name="optin" id="optin" {{ ($crew_member->optin) == '' }}) value="{{ $crew_member->optin }}">
                            ...
                            <div class="form-group col-xl-4 col-lg-12">
                                <div class="profile-picture">
                                    ...
                                    <div class="teck-btn bg-white upload-btn">
                                        ...
                                        <a href="#!"><img src="{{ asset("assets/images/camera.svg") }}"  class="btn-icon-2"
                                                alt=""> Update Image </a>
                                    </div>
                                </div>
                            </div>
