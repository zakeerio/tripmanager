                ...
                <div class="col-xl-5 col-lg-12">
                    <div class="btn-filter">
                        <div class="teck-btn justify-content-start bg-white">
                            <a href="#!"><img src="{{ asset("assets/images/rol icon.png") }}"
                                    class="btn-icon-2" alt=""> Filter by Role </a>
                        ...
                        <div class="teck-btn justify-content-end">
                            <a href="{{ url("crew-members-create") }}"><img src="{{ asset("assets/images/user.png") }}"
                                    class="img-fluid">Create new user</a>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="table-div">
                                                ...
                                                <p> <b> {{ $crewmember->fullname }}</b> <br> ({{ $crewmember->initials }}) </p>
                                            </div>
                                        </td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="BtnAction">
                                                    <a class="dropdown-item"
                                                        href="{{ url("crew-members-edit") }}/{{ $crewmember->id }}">Edit</a>
                                ...
                                {{-- <tr>
                                    ...
                                    <td class="action">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="BtnAction">
                                                <a class="dropdown-item"
                                                    href="{{ url("crew-members-edit") }}">Edit</a>
                                                <a class="dropdown-item" href="#">Delete</a>
                                            </div>
                                        </div>
                                    </td>
