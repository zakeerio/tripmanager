                ...
                <div class="col-xl-4 col-lg-12 teck-btn-pag-2">
                    <div class="btn-filter">
                        ...
                        <div class="teck-btn justify-content-end">
                            <a href="{{ url("all-activities-create") }}"><img src="{{ asset("assets/images/clander icon.png") }}" class="img-fluid">Create Activity</a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td data-th="Net Amount">
                                            <span class="active-btn"><img src="{{ asset("assets/images/Activity-Ready-Button.png") }}"
