            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-12">
                    <div class="teck-btn justify-content-end" id="teck-btn-pag-3">
                        <a href="{{ url("all-activities-create") }}"><img src="{{ ("assets/images/clander icon.png")}}"
                                class="img-fluid">Create Activity</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <table class="rwd-table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> ADL, CH, KW1, <br> </td>
                                    <td> <span class="active-btn"><img src="{{ asset("assets/images/Activity-Ready-Button.png")}}"
                                    ...
                                    <td class="action">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="BtnAction">
                                                <a class="dropdown-item" href="{{ url("all-activities-edit") }}">Edit</a>
                                ...
                                <tr class="teck-danger">
                                    ...
                                    <td class="crew_btn"> <span class="active-btn-2"><img
                                                src="{{ asset("assets/images/Button-Crew-Needed.png")}}" class="alrt-image"
                                                alt=""> Crew Needed</span> </td>
