    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="burger-menu">
                ...
                <ul class="main-menu"> 
                    <li class="menu-item" id="menu-item-pag-2">
                        <a href="./index.php">
                    ...
                    <li class="menu-item active" id="menu-item-pag-2">
                                    ...
                                    <div class="col-xl-4 col-lg-12 teck-btn-pag-2">
                                        <div class="btn-filter">
                                            <div class="teck-btn justify-content-start bg-white">
                                                <a href="#!"><img src="./assets/images/Activity-Items.png" class="btn-icon-2" alt=""> Filter by activity item </a>
                                            ...
                                            <div class="teck-btn justify-content-end">
                                                <a href="./all-activities-create.php"><img src="./assets/images/clander icon.png" class="img-fluid">Create Activity</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                          ...
                                          <td class="action">
                                              ...
                                              <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="BtnAction">
                                                    <a class="dropdown-item" href="./all-activities-edit.php">Edit</a>
                                      ...
                                      <tr class="teck-danger">
                                        ...
                                        <td data-th="Net Amount" class="crew_btn">
                                            <span class="active-btn-2"><img src="./assets/images/Button-Crew-Needed.png" class="alrt-image" alt=""> Crew Needed</span>
                                          </td>
