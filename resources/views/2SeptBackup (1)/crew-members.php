                            ...
                            <div class="col-md-12 dashboard_Sec">
                                <div class="row">
                                    <div class="col-xl-7 col-lg-12">
                                        <h1>Crew Members</h1>
                                        <p class="sub-pages-text" >This is a list of all the scheduled activities in the Activity Manager system..</p>
                                    </div>
                                    
                                    <div class="col-xl-5 col-lg-12">
                                        <div class="btn-filter">
                                            <div class="teck-btn justify-content-start bg-white">
                                                <a href="#!"><img src="./assets/images/rol icon.png" class="btn-icon-2" alt=""> Filter by Role </a>
                                            ...
                                            <div class="teck-btn justify-content-end">
                                                <a href="./crew-members-create.php"><img src="./assets/images/user.png" class="img-fluid">Create new user</a>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                                ...
                                <table class="rwd-table">
                                    <tbody>
                                        ...
                                        <td class="action">
                                          <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="BtnAction">
                                                <a class="dropdown-item" href="./crew-members-edit.php">Edit</a>
                                      ...
                                      <tr>
                                        <td>
                                          <div class="table-div">
                                            <img src="./assets/images/crew-02.png" class="img-fluid" alt="">
                                            <p> <b> Rod Auton</b>  <br>  (RA) </p>
                                          </div>
                                        </td>
                                        <td> rodauton@example.com </td>
