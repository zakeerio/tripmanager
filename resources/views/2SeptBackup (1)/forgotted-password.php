...
<html lang="en">
  ...
  <head>
    ...
    <title> Forgotted Password </title>
...
<section class="banner-section login-page">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12 m-auto" id="main">
                                ...
                                <form class="teck-form">
                                  <div class="form-row">
                                    ...
                                    <div class="form-group col-xl-12 col-lg-12">
                                      ...
                                      <input type="email" class="form-control" id="email-address" value="">
                                    ...
                                    <div class="form-group col-xl-12 col-lg-12">
                                        <label for="ActivityTime">FORGOTTED PASSWORD</label>
                                    ...
                                    <div class="teck-btn">
                                        <button type="submit" class="btn btn-primary"> <img src="./assets/images/save.svg" class="img-fluid"> Submit </button>
                                    </div>
                                </form>
