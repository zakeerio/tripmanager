                                        ...
                                        <div class="form-group col-xl-8 col-lg-12">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-xl-4 col-lg-6">
                                                  ...
                                                  <input type="email" class="form-control" id="EmailAddress" value="rodauton@example.com">
                                                </div>
                                                ...
                                                <div class="form-group col-xl-8 col-lg-12">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                          ...
                                                          <input type="number" class="form-control" id="CctMembershipNumber" value="2085">
                                                        </div>
