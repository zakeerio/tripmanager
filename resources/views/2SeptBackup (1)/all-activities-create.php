...
<html lang="en">
  ...
  <head>
    ...
    <title> All Activities - Create </title>
  </head>
                                ...
                                <form class="teck-form">
                                  ...
                                  <div class="form-row">
                                    ...
                                    <div class="form-group col-xl-4 col-lg-12">
                                      ...
                                      <input type="text" class="form-control" id="BriefDescription">
                                    </div>
                                  </div>
                                  ...
                                  <div class="form-row">
                                    ...
                                    <div class="form-group col-xl-4 col-lg-12">
                                      ...
                                      <input type="text" class="form-control" id="NumberCrewNeeded">
                                    </div>
                                    
                                    <div class="form-group col-md-12">
                                      <label for="NotesCrew">NOTES FOR CREW</label>
                                      <textarea class="form-control" id="NotesCrew" rows="5"></textarea>
                                    </div>
                                  </div>
